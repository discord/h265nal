...
std::unique_ptr<H265SeiMessageParser::SeiMessageState>
H265SeiMessageParser::ParseSei(h265nal_base::BitBuffer* bit_buffer) noexcept {
...
H265SeiUserDataRegisteredItuTT35Parser::parse_payload(
    h265nal_base::BitBuffer* bit_buffer, uint32_t payload_size) {
...
std::unique_ptr<H265SeiPayloadParser::H265SeiPayloadState>
H265SeiUserDataUnregisteredParser::parse_payload(h265nal_base::BitBuffer* bit_buffer,
...
std::unique_ptr<H265SeiPayloadParser::H265SeiPayloadState>
H265SeiUnknownParser::parse_payload(h265nal_base::BitBuffer* bit_buffer,
                                    uint32_t payload_size) {
